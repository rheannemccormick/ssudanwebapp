var data = [
  ...
  },
  {
    ...
    "status_message": "#SouthSudanTalks: Officials in Ethiopia say peace talks for South Sudan are stalled over the issue of political prisoners. Officials described the talks as \"on and off\" after the special envoy of a bloc of East African countries known as IGAD flew to South Sudan to speak about political detainees. Ethnic—based violence broke out in South Sudan on Dec. 15. President Salva Kiir says his former Vice President, Riek Machar, tried to launch a coup. Mr. Machar's side is demanding the release of 11 high-level detainees. Mr. Kiir has said they will be released according to judicial procedures.\n\nYOUR COMMENTS?\n\n#SSN\n#SSpoliticsCrisis",
    "link_name": "",
    "status_type": "status",
    "status_link": "",
  ...
  },
  {
    ...
    "status_message": "December 15, 2013 (JUBA) – Military clashes\nhave occurred between the presidential guards\nof South Sudan's president, Salva Kiir in the\ncapital, Juba.\nThe clashes\noccurred from\nabout 10pm last\nnight in the old\nmilitary barracks\ninside the capital\nand continued\nintensively for\nabout one hour\nbefore one\ngroup was\nexpelled.\nSporadic gunfire\nrocked the new\nnation's capital\nover night\nsending\nresidents into a\nstate of panic as\nmovements\nwere controlled by the military.\nMilitary sources said the clashes between the\nTiger special force occurred when one group\npredominantly of Nuer was suspicious in the\ndeployments of the other group dominated by\nthe Dinka, further turning the arguments into\ndeadly clashes.\nThe source said the group predominantly of\nNuer have expelled their colleagues\npredominantly of Dinka, composed mostly of\nthose who were recently graduated by president\nKiir at Luri bridge and deployed at the old\nmilitary barracks.\nThe situation is now calm, but tense amidst\nfears that it may escalate as soldiers have been\ndeploying in various strategic locations. No\ncasualties have been reported so far.\nEyewitnesses told Sudan Tribune that the\nfighting was fierce as those chased out of the\nbarracks withdrew into the rest of the city.\nARMY URGES CALM\nThe South Sudan's army, meanwhile, warned\nresidents of the capital, Juba, to remain in their\nhomes after gun shoots and explosions were\nheard overnight.\n\"We request people to remains in their\nresidences until we establish the actual cause of\nthe shootings\", Phillip Aguer, the SPLA's\nspokesperson told Sudan Tribune .\nThe army, Aguer said, regrets the unfortunate\nincident which has left the Juba population in a\nstate of panic, but gave no further details on\ncasualties involved.\nIn 2006, a similar incident occurred when part\nof the military mutinied over unpaid salaries\nprompting fierce battle between forces loyal to\nthe establishment and the mutineers at a\nmilitary barracks at Gumbo, a few kilometers\nout of Juba town.\nThe situation was tense with reports of\ncasualties and civilians beaten up on the streets\nby the mutineers as the military prevented\npeople from moving out of their houses.\nMore details to follow.\n\ncheck our auto updates online on sudantribune.com",
    "link_name": "",
    "status_type": "status",
    "status_link": "",
  ...
  },
  {
    ...
    "status_message": "Let us pause and give thanks for the fact that Nelson Mandela lived—a man who took history in his hands and bent the arc of the moral universe toward justice.\" —President Obama\n\n#R.I.P Nelson Mandela",
    "link_name": "",
    "status_type": "status",
    "status_link": "",
  ...
  },
  {
    ...
    "status_message": "All the 10 states with exception of Central Equatoria…there is no Governor now sitting in his own office. They all come to Juba here to find out what is happening,\" Aleu said while addressing governors on Friday during a forum in Juba.\n\nDo you believe the minister?\n\nSee more on our official website >>> Gurtong.net",
    "link_name": "",
    "status_type": "status",
    "status_link": "",
  ...
  },
  {
    ...
    "status_message": "President Kiir appointed Deng Deng Hoc as the minister of environment replacing Abdulla Deng Nhial who was shockingly sacked some  fèw days ago!",
    "link_name": "",
    "status_type": "status",
    "status_link": "",
  ...
  },
  {
    ...
    "status_message": "Today's South Sudan proverb. If the be stung you, you donn't have to destroy the whole of beehive «« sent by Luny Nhial Kier»»",
    "link_name": "",
    "status_type": "status",
    "status_link": "",
  ...
  },
  {
    ...
    "status_message": "Authorities in the office of newly appointed Mayor of Juba has arrested 100 ladies accused of prostitution in Jebel market. They are expected to appear in court soon with majority of them foreigners. ««Stay update.»»",
    "link_name": "",
    "status_type": "status",
    "status_link": "",
  ...
  },
  {
    ...
    "status_message": "Two spla solidiers sentence to death for crimes in Jonglei.......                            Media bills returned to parliament for further scrutiny. « STAY UPDATE»",
    "link_name": "",
    "status_type": "status",
    "status_link": "",
  ...
  },
  {
    ...
    "status_message": "Khartoum welcomed the recapture of a town in ˝South Kordofan\" on Monday by the Sudan Armed Forces (SAF) and called to settle the conflict .",
    "link_name": "",
    "status_type": "status",
    "status_link": "",
  ...
  },
  {
    ...
    "status_message": "Sad News : to All of greater Equatorians and south sudan in General.by losing the Catholic Bishop of Torit Eastern Equatoria state which passed Away yesterday on sunday in Nairobi at Aga Khan Hospital.late Johnson Akio Mutek aged 55 Years and He was been Ordained as a Bishop on December 18 1988,Appointed as a Auxiliary Bishop on May 18 1999,Consecrate­d as A Bishop on 15 August 1999,and become a Bishop of Torit on 9 June 2007.Big Sorrow may his Soul Rest in Peace Amen.\n\n#facebook.com/Southsudan.news",
    "link_name": "",
    "status_type": "status",
    "status_link": "",
...
//var search = JSON.search((data)+','+'"//*'+[searchQuery]+'"');

//working out how to for loop function the array with i
var data3 = [1, 2, 3];

var dataSearcher = function(dataV){
  for(i=0;i<dataV.length;){
...
// above json from scraper is saved under variable data (an array) so 476 objects inside one array

// so for each [0-476] in the array data get the status_message key and console.log


// this function can be used to loop through whatever task needs to be run for a total amount of the array number
var dataSearcher = function(dataV){
  for(i=0;i<100;){

    console.log(data[i].status_message);
    i++;
  }
}
